const Terms = () => {
    return (
        <>
            ...
            <p>Welcome to Afreakin!</p>

            <p>
                These terms and conditions outline the rules and regulations for
                the use of Afreakin{"'"}s Website, located at afreakin.art.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Afreakin if you do not agree
            ...
            <p>
                We employ the use of cookies. By accessing Afreakin, you agreed
                to use cookies in agreement with the Afreakin{"'"}s Privacy
                Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, Afreakin and/or its licensors own the
                intellectual property rights for all material on Afreakin. All
                intellectual property rights are reserved. You may access this
                from Afreakin for your own personal use subjected to
                restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Afreakin</li>
                <li>Sell, rent or sub-license material from Afreakin</li>
                <li>Reproduce, duplicate or copy material from Afreakin</li>
                <li>Redistribute content from Afreakin</li>
            </ul>
            ...
            <p>
                ...
                website. Afreakin does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Afreakin,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Afreakin shall not be liable for
            ...
            <p>
                Afreakin reserves the right to monitor all Comments and to
            ...
            <p>
                You hereby grant Afreakin a non-exclusive license to use,
            ...
            <p>
                ...
                of Afreakin; and (d) the link is in the context of general
            ...
            <p>
                ...
                by sending an e-mail to Afreakin. Please include your name, your
            ...
            <p>
                No use of Afreakin{"'"}s logo or other artwork will be allowed
